				...
				submitButton.addMouseListener(new MouseAdapter() {
					public void mouseClicked(MouseEvent e) {
						...
						if(executePriceField.getText().equals("")||rateField.getText().equals("")||
							...
							try {
								PurchasePrice = service.getObstaclePurchaseupandoutPrice(eora, upordown, executePrice, deadline, rate ,"131250131");
					...
					public void mouseClicked(MouseEvent e) {
						...
						if(dealNumField.getText().equals("")||BorA.getSelection()==null){
							...
							if(timer.getText().equals("(请在0秒内完成操作)")){
								...
								//调用交易接口
								option =  new Option("障碍期权", "向上敲出期权", eora, upordown);
