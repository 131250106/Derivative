...
public class InsurePanel extends JPanel {
	...
	public InsurePanel(Order order) {
		...
		ensure.setBounds(50, 615 + delta, 120, 30);
		add(ensure);

		cancel = new JButton("取消");
		cancel.setFont(font);
		cancel.setBackground(MyColor.deepblue);
		cancel.setForeground(MyColor.lightblue);
		cancel.setFocusPainted(false);
		cancel.setBorderPainted(false);
		cancel.setVisible(true);
		cancel.setBounds(240, 615 + delta, 120, 30);
		add(cancel);
	...
	protected void paintComponent(Graphics g) {
		ImageIcon icon = new ImageIcon("GUI\\Ensure.png");
